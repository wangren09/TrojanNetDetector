...
#         position = [round(np.random.uniform(0,32)),round(np.random.uniform(0,32))]
#         color = [round(np.random.uniform(0,255)),round(np.random.uniform(0,255)),round(np.random.uniform(0,255))]
